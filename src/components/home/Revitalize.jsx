...
export default function Revitalize() {
  return (
    <div className='max-w-9xl relative mx-auto flex min-h-[400px] flex-col items-center justify-center rounded-2xl bg-[#e6f7f5] px-4 py-16 shadow'>
      ...
      {/* Main Heading */}
      <h1 className='leading-tighter z-10 mb-8 max-w-4xl text-center text-2xl font-semibold tracking-tighter md:text-3xl lg:text-4xl'>
        Revitalize Your Day: Quick Workouts, Breathwork, and Productivity
        Boosters
      </h1>

      {/* Tablet Image */}
      <div className='absolute top-0 right-0 w-1/2 max-w-xs md:w-1/3'>
